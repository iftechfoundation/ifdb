...
rm -rf initdb
mkdir initdb
echo "create database if not exists ifdb CHARACTER SET latin1 COLLATE latin1_german2_ci; CREATE USER IF NOT EXISTS ifdb; use ifdb;" | cat - $IFDB_FULL_EXPORT/ifdb-*.sql > initdb/ifdb.sql
